...
//WebUI.callTestCase(findTestCase('5-Checkout_items/5-verify first name field only acceptable alphabet char'), [:], FailureHandling.STOP_ON_FAILURE)
...
WebUI.setText(findTestObject('Checkout/verify mandatory field/input_Checkout Your Information_firstName'), 'test')
...
if (!(currentUrl.equals(expectedUrl))) {
    ...
    WebUI.comment('Error with note: Inputan form sebelumnya pada lastname tidak sesuai format.')
