...
//WebUI.callTestCase(findTestCase('3-Main_Menu/4-verify the product have title'), [:], FailureHandling.STOP_ON_FAILURE)

// Definisikan XPath yang ingin digunakan
String xpathExpression = '//div[@id="inventory_container"]//div[@data-test="inventory-item-desc"]'
