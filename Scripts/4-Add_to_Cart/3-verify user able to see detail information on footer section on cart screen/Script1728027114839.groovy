...
//WebUI.callTestCase(findTestCase('4-Add_to_Cart/2-verify user able to see detail information on cart screen'), [:], FailureHandling.STOP_ON_FAILURE)

'Footer section'
WebUI.verifyElementVisible(findTestObject('MainMenu/your_cart/footer/a_Twitter'))

WebUI.click(findTestObject('MainMenu/your_cart/footer/a_Twitter'))
...
WebUI.verifyElementVisible(findTestObject('MainMenu/your_cart/footer/a_Facebook'))

WebUI.click(findTestObject('MainMenu/your_cart/footer/a_Facebook'))
...
WebUI.verifyElementVisible(findTestObject('MainMenu/your_cart/footer/a_LinkedIn'))

WebUI.click(findTestObject('MainMenu/your_cart/footer/a_LinkedIn'))
...
WebUI.verifyElementText(findTestObject('MainMenu/your_cart/footer/title_footer'), '© 2024 Sauce Labs. All Rights Reserved. Terms of Service | Privacy Policy')
