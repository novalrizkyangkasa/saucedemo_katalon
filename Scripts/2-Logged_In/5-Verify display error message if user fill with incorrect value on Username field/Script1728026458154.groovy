...
//WebUI.callTestCase(findTestCase('2-Logged_In/4-Verify display error message if user enter incorrect value the form'), [:], 
...
WebUI.setText(findTestObject('Object Repository/Homepage/login_field/input_Swag Labs_user-name'), 'test')
...
WebUI.verifyEqual(valueuser, 'test', FailureHandling.STOP_ON_FAILURE)
